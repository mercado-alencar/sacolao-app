...
const createTemplateSorteio = sorteio => `<html class="focus-outline-visible"><head> <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> <title>MERCADO ALENCAR - Comprovante</title> <style> @page { margin: 0cm; } </style> </head> <body> <div style="width: 8cm;padding-right: 5px;font-size: 13px;font-weight: bold;font-family: 'Helvetica';"> <div style="width: 100%; text-align: center;"> <img src="http://mercadoalencar.com.br/cestinha.png" style=" width: 100px; display: block; margin: auto; "> <span style="font-weight: bold;font-size: 28px;">MERCADO ALENCAR</span></div> <br> <div style="width: 100%; text-align: center;"><span style="font-weight: bold;font-size: 18px;">SORTEIO DE NATAL</span></div> <br> <div style="clear: both;"><span style="float: left; font-weight: bold; font-size: 12px;">Seu número da sorte:</span> <span style="float: right; text-align: right;">${sorteio.id}</span></div> <br> <br>  <br> <hr> <div> <div style="clear: both;"> <span style="">1º Premio</span>  </div> <div style=" font-size: 18px; text-align: center; "> Um Sacolão de 300 </div> <div style="clear: both;">   </div> <br> <hr> <div> <div style="clear: both;"> <span style="">2º Premio</span>  </div> <div style=" font-size: 18px; text-align: center; ">Uma cesta de Bebidas</div> <div style="clear: both;">   </div> <br> <hr> </div><div> <div style="clear: both;"> <span style="">1º Premio</span>  </div> <div style=" font-size: 18px; text-align: center; ">Uma cesta de Carne</div> <div style="clear: both;">   </div> <br> <hr> </div></div> <br> </div> <script> setTimeout(function(){console.log('teste'); window.print(); console.log('imprimindo'); },500); </script> </body></html>`;
