...
const convert = (model) => {
    ...
    printable.trocoPara = eval(
      Number(
        eval((printable.trocoPara || 0).toString().replace(",", "."))
      ).toFixed(2)
    );
